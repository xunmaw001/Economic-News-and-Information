        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="推荐类型" prop="tuijianTypes">
                        <el-select v-model="ruleForm.tuijianTypes" :disabled="ro.tuijianTypes" placeholder="请选择推荐类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="推荐类型" prop="tuijianValue">
