    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公告标题" prop="gonggaoName">
                       <el-input v-model="ruleForm.gonggaoName"
                                 placeholder="公告标题" clearable  :readonly="ro.gonggaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="公告标题" prop="gonggaoName">
                           <el-input v-model="ruleForm.gonggaoName"
