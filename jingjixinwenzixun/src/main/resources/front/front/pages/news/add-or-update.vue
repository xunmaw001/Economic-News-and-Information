            ...
            <view
                ...
                <view
                    ...
                    <view class="right-input" style="padding:0;textAlign:left">
                      ...
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">推荐类型</view>
                    <picker @change="tuijianTypesChange" :value="tuijianTypesIndex" :range="tuijianTypesOptions" range-key="indexName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.tuijianTypes?ruleForm.tuijianValue:"请选择推荐类型"}}</view>
                    </picker>
                </view>
<!-- text后缀 -->
            <view
...
<script>
    ...
    export default {
		...
		/*下拉框*/
			let tuijianTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'tuijian_types',
            }
			let tuijianTypes = await this.$api.page(`dictionary`, tuijianTypesParams);
			this.tuijianTypesOptions = tuijianTypes.data.list
        ...
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.tuijianTypes)) {
                    this.$utils.msg(`推荐类型不能为空`);
                    return
                }
                if (this.ruleForm.id) {
