...
public class DuanshipinCollectionView extends DuanshipinCollectionEntity implements Serializable {
	...
	*/
	...
	private String duanshipinCollectionValue;
	...
	public DuanshipinCollectionView() {

	}

	public DuanshipinCollectionView(DuanshipinCollectionEntity duanshipinCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, duanshipinCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getDuanshipinCollectionValue() {
		return duanshipinCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setDuanshipinCollectionValue(String duanshipinCollectionValue) {
		this.duanshipinCollectionValue = duanshipinCollectionValue;
	}
	...
	public String toString() {
		return "DuanshipinCollectionView{" +
			", duanshipinCollectionValue=" + duanshipinCollectionValue +
